...
@section('title','ฟอร์ม นขต.กอ.รมน.')
                            ...
                            <div class="row gy-5 g-xl-8">
                                    ...
                                    <div class="card card-xl-stretch mb-5 mb-xl-12">
                                        ...
                                        <div class="card-header border-0 pt-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder fs-3 mb-1">แบบฟอร์มที่ 1 ขอตัวช่วยราชการ โดย นขต.กอ.รมน.</span>
                                            </h3>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <div class="card card-xl-stretch mb-5 mb-xl-12">
                                        ...
                                        <div class="card-header border-0 pt-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder fs-3 mb-1">แบบฟอร์มที่ 1 ขอตัวช่วยราชการ โดย นขต.กอ.รมน. (เติมให้เติม)</span>
                                            </h3>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
