...
<head>
	<base href="../../">
	<title>กรอกข้อมูลขอตัวช่วยราชการ</title>
	<meta charset="utf-8" />
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										...
										<div class="menu-sub menu-sub-accordion menu-active-bg">
											<div class="menu-item">
												<a class="menu-link" href="{{ route('form') }}">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									...
									<span class="menu-title">อัพโหลดบัญชีฯ</span>
									<span class="menu-arrow"></span>
								</span>
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									<div class="menu-item">
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									...
									<span class="menu-title">คำสั่งปฏิบัติ</span>
									<span class="menu-arrow"></span>
								</span>
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									...
									<span class="menu-title">คำสั่งพ้น</span>
									<span class="menu-arrow"></span>
								</span>
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									...
									<span class="menu-title">คำสั่งปิดห้วง</span>
									<span class="menu-arrow"></span>
								</span>
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									<div class="menu-item">
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									...
									<span class="menu-title">แก้ไขคำสั่ง</span>
									<span class="menu-arrow"></span>
								</span>
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									<div class="menu-item">
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									...
									<span class="menu-title">หนังสือรับรองฯ</span>
									<span class="menu-arrow"></span>
								</span>
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									<div class="menu-item">
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									...
									<span class="menu-title">อัพโหลดหนังสือฯ</span>
									<span class="menu-arrow"></span>
								</span>
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									<div class="menu-item">
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									...
									<span class="menu-title">OCR</span>
									<span class="menu-arrow"></span>
								</span>
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									<div class="menu-item">
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									...
									<span class="menu-title">สืบค้น</span>
									<span class="menu-arrow"></span>
								</span>
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									<div class="menu-item">
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									...
									<span class="menu-title">จัดการข้อมูลฯ</span>
									<span class="menu-arrow"></span>
								</span>
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									<div class="menu-item">
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									...
									<span class="menu-title">ทำเนียบ</span>
									<span class="menu-arrow"></span>
								</span>

								<div class="menu-sub menu-sub-accordion menu-active-bg">
									<!-- ทำเบียบ ชรก.(ส่วนกลาง) -->
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										<span class="menu-link">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
											<span class="menu-title">ทำเบียบ ชรก.(ส่วนกลาง)</span>
											<span class="menu-arrow"></span>
										</span>
										...
										<div class="menu-sub menu-sub-accordion menu-active-bg">
											<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
												<span class="menu-link">
													...
													<span class="menu-title">ส่วนบริหาร</span>
													<span class="menu-arrow"></span>
												</span>
												...
												<div class="menu-sub menu-sub-accordion menu-active-bg">
													<div class="menu-item">
														<a class="menu-link" href="../../demo1/dist/pages/projects/list.html">
															...
															<span class="menu-title">สำนักงาน ผอ.รมน</span>
														</a>
													</div>
													<div class="menu-item">
														<a class="menu-link" href="../../demo1/dist/pages/projects/project.html">
															...
															<span class="menu-title">สำนักงาน รอง ผอ.รมน</span>
														</a>
													</div>
													<div class="menu-item">
														<a class="menu-link" href="../../demo1/dist/pages/projects/targets.html">
															...
															<span class="menu-title">สำนักงานผู้ช่วย กอ.รมน.</span>
														</a>
													</div>
													<div class="menu-item">
														<a class="menu-link" href="../../demo1/dist/pages/projects/budget.html">
															...
															<span class="menu-title">สำนักงานเลขาธิการ กอ.รมน</span>
														</a>
													</div>
													<div class="menu-item">
														<a class="menu-link" href="../../demo1/dist/pages/projects/users.html">
															...
															<span class="menu-title">สำนักงานรองเลขาธิการ กอ.รมน(1)</span>
														</a>
													</div>
													<div class="menu-item">
														<a class="menu-link" href="../../demo1/dist/pages/projects/files.html">
															...
															<span class="menu-title">สำนักงานรองเลขาธิการ กอ.รมน(2)</span>
														</a>
													</div>
													<div class="menu-item">
														<a class="menu-link" href="../../demo1/dist/pages/projects/activity.html">
															...
															<span class="menu-title">สำนักงานรองเลขาธิการ กอ.รมน(3)</span>
														</a>
													</div>
													<div class="menu-item">
														<a class="menu-link" href="../../demo1/dist/pages/projects/settings.html">
															...
															<span class="menu-title">สำนักงานรองเลขาธิการ กอ.รมน(4)</span>
														</a>
													</div>
													<div class="menu-item">
														<a class="menu-link" href="../../demo1/dist/pages/projects/settings.html">
															...
															<span class="menu-title">สำนักงานผู้ช่วยเลขาธิการ กอ.รมน</span>
														</a>
													</div>
												</div>
											</div>
											...
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/projects.html">
													...
													<span class="menu-title">สลก.กอ.รมน.</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/campaigns.html">
													...
													<span class="menu-title">สลต.กอ.รมน.</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/documents.html">
													...
													<span class="menu-title">สพร.กอ.รมน</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/followers.html">
													...
													<span class="menu-title">สกส.กอ.รมน.</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/followers.html">
													...
													<span class="menu-title">สจร.กอ.รมน.</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/followers.html">
													...
													<span class="menu-title">สนย.กอ.รมน.</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/followers.html">
													...
													<span class="menu-title">สขว.กอ.รมน.</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/followers.html">
													...
													<span class="menu-title">สมท.กอ.รมน.</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/followers.html">
													...
													<span class="menu-title">สบค.กอ.รมน.</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/followers.html">
													...
													<span class="menu-title">สกบ.กอ.รมน.</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/followers.html">
													...
													<span class="menu-title">สปง.กอ.รมน.</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/followers.html">
													...
													<span class="menu-title">สบข.กอ.รมน.</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/followers.html">
													...
													<span class="menu-title">ศดม.กอ.รมน.</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/followers.html">
													...
													<span class="menu-title">ศศว.กอ.รมน.</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/followers.html">
													...
													<span class="menu-title">ศปป1.กอ.รมน.</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/followers.html">
													...
													<span class="menu-title">ศปป2.กอ.รมน.</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/followers.html">
													...
													<span class="menu-title">ศปป3.กอ.รมน.</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/followers.html">
													...
													<span class="menu-title">ศปป4.กอ.รมน.</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/profile/followers.html">
													...
													<span class="menu-title">ศปป5.กอ.รมน.</span>
												</a>
											</div>
										</div>
									</div>

									<!-- ทำเนียบ ขรก.พลเรือนประจำ ฯ -->
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										<span class="menu-link">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
											<span class="menu-title">ทำเนียบ ขรก.พลเรือนประจำ ฯ</span>
											<span class="menu-arrow"></span>
										</span>
									...
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										<span class="menu-link">
											...
											<span class="menu-title">ทำเนียบ ลูกจ้าง</span>
											<span class="menu-arrow"></span>
										</span>
										<div class="menu-sub menu-sub-accordion menu-active-bg">
											<div class="menu-item">
									...
									<!-- ทำเนียบ พนักงานราชการ -->
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										<span class="menu-link">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
											<span class="menu-title">ทำเนียบ พนักงานราชการ</span>
											<span class="menu-arrow"></span>
										</span>
										<div class="menu-sub menu-sub-accordion menu-active-bg">
											<div class="menu-item">
									...
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										<span class="menu-link">
											...
											<span class="menu-title">สรุปสถานภาพกำลังพล</span>
											<span class="menu-arrow"></span>
										</span>
										<div class="menu-sub menu-sub-accordion menu-active-bg">
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/blog/home.html">
													...
													<span class="menu-title">รวมสถานภาพกำลังพล</span>
												</a>
											</div>
											<div class="menu-item">
												<a class="menu-link" href="../../demo1/dist/pages/blog/post.html">
													...
													<span class="menu-title">เฉพาะประเภท</span>
												</a>
											</div>
										</div>
									</div>
									...
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										<span class="menu-link">
											...
											<span class="menu-title">ทำเนียบ สง.ปรมน.</span>
											<span class="menu-arrow"></span>
										</span>
										<div class="menu-sub menu-sub-accordion menu-active-bg">
											<div class="menu-item">
									...
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										<span class="menu-link">
											...
											<span class="menu-title">Admin กอ.รมน.ส่วนกลาง</span>
											<span class="menu-arrow"></span>
										</span>
										<div class="menu-sub menu-sub-accordion menu-active-bg">
											<div class="menu-item">
							...
							<div class="card mb-5 mb-xxl-8">
								<div class="container">
									...
									<form action="#" method="post" enctype="multipart/form-data">
										...
										<div class="head position-relative mt-1" align="center">
											<h1 class="card-text" style="font-size:18px;">กรอกข้อมูลขอตัวช่วยราชการ</h1>
										</div>

										<br>
										<div class="input-group mb-3">
											<span class="input-group-text">ยศ</span>
											<input type="text" class="form-control" placeholder="ป้อนยศ">
											<span class="input-group-text">ชื่อ</span>
											<input type="text" class="form-control" placeholder="ป้อนชื่อ">
											<span class="input-group-text">นามสกุล</span>
											<input type="text" class="form-control" placeholder="ป้อนนามสกุล">
										</div>

										<div class="input-group mb-3">
											<span class="input-group-text">เลข 10 หลัก</span>
											<input type="text" class="form-control" placeholder="ป้อนเลข 10 หลัก">
											<button class="btn btn-warning" type="submit">ดูตัวอย่าง</button>
										</div>
										<div class="input-group mb-3">
											<span class="input-group-text">เลข 13 หลัก</span>
											<input type="text" class="form-control" placeholder="ป้อนเลข 13 หลัก">
											<button class="btn btn-primary" type="submit">แก้ไข</button>
										</div>
										<div class="input-group mb-3">
											<span class="input-group-text">ตำแหน่งปกติ</span>
											<input type="text" class="form-control" placeholder="ป้อนตำแหน่งปกติ">
											<button class="btn btn-success" type="submit">ยืนยัน</button>
										</div>
										<div class="input-group mb-3">
											<span class="input-group-text">สังกัด</span>
											<input type="text" class="form-control" placeholder="ป้อนสังกัด">
										</div>

										<div class="form-row">
											<div class="form-group col-md-12" align="center">
												<p>ตำแหน่งชรก. ในกอ.รมน.(ตำแหน่งว่างใน กอ.รมน. ที่ จนท.คลิ๊กเข้ามา</p>
											</div>
										</div>
